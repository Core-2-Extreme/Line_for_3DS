...
void Sem_worker_thread(void* arg)
{
	...
	while (sem_thread_run)
	{
		if (sem_reload_msg_request)
		{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Gtr_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Spt_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Imv_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Cam_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Mic_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
			...
			Util_log_save(DEF_SEM_WORKER_THREAD_STR, "Mup_load_msg()..." + result.string + result.error_description, result.code);
			if (result.code != 0)
			{
