...
extern C2D_SpriteSheet Background_texture, Wifi_icon_texture, Battery_level_icon_texture, Battery_charge_icon_texture, Setting_bar_texture, Chinese_font_texture, Arabic_font_texture, Armenian_font_texture, English_font_texture, Punctuation_close_font_texture;
extern C2D_Image Background_image[2], Wifi_icon_image[9], Battery_level_icon_image[21], Battery_charge_icon_image[1], Setting_bar_image[1], Chinese_font_image[2], Arabic_font_image[255], Armenian_font_image[92], English_font_image[96], Punctuation_close_font_image[93];
